...
CREATE TABLE `interacciones` (
  ...
  CONSTRAINT `interacciones_ibfk_1` FOREIGN KEY (`ID_Mascota`) REFERENCES `mascotas` (`ID_Mascota`),
  CONSTRAINT `interacciones_ibfk_2` FOREIGN KEY (`ID_Adoptante`) REFERENCES `adoptantes` (`ID_Adoptante`)
...
-- Dump completed on 2024-11-17 12:39:33
