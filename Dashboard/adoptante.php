	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Usuarios <small>Adoptante</small>
				</h1>
			</div>
			<p class="lead">En esta pagina puedes registrar usuarios adoptantes y comprobar los existentes</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form action="php/adoptante.php" method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<input class="form-control" type="date" name="FechaRegistro" required>
											</div>
											<p class="text-center">
