	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles"><i class="zmdi zmdi-money zmdi-hc-fw"></i> Adopcion <small>Adopcion</small></h1>
			</div>
			<p class="lead">Esta pestaña te permite agregar mas mascotas y ver las que ya estan en la base de datos.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="new">
							...
							<form action="registro_perro.php" method="POST" enctype="multipart/form-data">
								<div class="form-group">
